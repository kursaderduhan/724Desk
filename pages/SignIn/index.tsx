    ...
    <Flex w={"full"} minH={"100vh"} alignItems={"center"}>
      <VStack w={"583px"} justifyContent={"center"} align={"center"} h={"full"}>
        <VStack alignItems={"flex-start"} pos={"relative"}>
          ...
          />
          <Text
            fontSize={{ base: "19px", lg: "28px" }}
            fontWeight={500}
            color={"#333333"}
            textStyle={"signInHead"}
            pt={"21px"}
          >
          ...
          <Flex flexDirection={"column"}>
            ...
            <HStack w={"full"} bg={"#D0DDE7"} rounded={5} mt={"8px"}>
              <ButtonGroup>
                {buttons.map((item) => (
                  <Button
                    bg={buttonColor === item.id ? "#2C4EC6" : "transparent"}
                    w={"75px"}
                    key={item.id}
          ...
          {choose
            .filter((itemText) => itemText.id === buttonColor)
            .map((items) => (
          ...
          <Button
            ...
            onClick={control}
            pos={"absolute"}
            top={{ base: "370px", lg: "410px" }}
          >
            <Image src={"/lock.png"} alt={"lock"} w={"18px"} h={"18px"} />
            Giriş Yap
          </Button>
          <HStack w={"full"} pt={{ base: "72px", lg: "141px" }}>
