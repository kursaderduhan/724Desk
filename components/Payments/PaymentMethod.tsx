...
import {
    VStack, Text, HStack, Button, Flex, InputGroup, Input, FormLabel, InputRightElement, Select, Checkbox, Icon, Modal, ModalOverlay, ModalContent, ModalHeader,
    ModalCloseButton, Radio, Image, Divider, ModalBody, RadioGroup, Circle, Stack,useDisclosure,
    ...
    <Flex flexDirection={'column'} h={'full'} justifyContent={'space-between'}>
      ...
      <Modal isOpen={isOpen} onClose={onClose} size={'lg'}>
        ...
        <ModalContent w={'490px'} h={'588px'}>
          <ModalHeader fontSize={'15px'} color={' #333333'} fontWeight={500}>
            Yeni kart ekle
          </ModalHeader>
          <ModalCloseButton />
          <Divider />
          ...
          <Stack direction='column' w={'full'}>
            <Radio value='1' w={'full'}>
              <HStack w={'full'} gap={20}>
                <Flex gap={5}>
                  <Image src={'/isBank.png'} alt={'is'} w={'42px'} h={'42px'} />
                  <VStack alignItems={'flex-start'}>
