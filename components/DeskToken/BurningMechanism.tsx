...
import { VStack, HStack, Flex, Image, Text, Button } from '@chakra-ui/react'
const BurningMechanism = () => {
  return (
    <VStack w={'full'} h={'943px'} bg={'#212842'} py={100} gap={20}>
      ...
      <Text
        ...
        color={'#C4C4C4'}
      >
        724desk will continue decreasing the total supply of BSW tokens with the
        help of a weekly burning <br /> mechanism, which should in turn increase
        ...
        <VStack gap={20} justifyContent={"center"}>
          <HStack>
            <Flex
              ...
              alignItems={'center'}
            >
              <Image src={'/rotate.png'} alt={'rotate'} w={'42px'} h={'42px'} />
            </Flex>
            <VStack alignItems={'flex-start'}>
              ...
              <Text
                ...
                w={'306px'}
              >
                50% from every transaction on the 724Desk platform are used for
                purchasing BSW tokens from the market and burning them.
              </Text>
            </VStack>
          </HStack>
          <HStack>
