                  ...
                  >
                    <VStack w={"full"}>
                      <Image
                        ...
                        h={"32px"}
                      />
                      <Text color={"#D4D4D4"} textStyle={"homePageSubText"}>
                        Birçok kanal
                      </Text>
                    </VStack>
                  </HStack>
      ...
      <Slider {...settings}>
        {categories.map((category) => (
          <SliderShow
            ...
            ImgLeft={category.ImgLeft}
            ImgRight={category.ImgRight}
            bg={category.bg}
...
const SliderShow = ({ TextHead, ...rest }: sliderProp) => {
  return (
    <Box
      w={{ base: "164px", lg: "288px" }}
    ...
    >
      <HStack w={"full"} h={"full"} pos={"relative"}>
        <VStack
          ...
          px={5}
        >
          <Image src={rest.ImgLeft} alt={"ımg"} w={"42px"} h={"42px"} />
          <Text
